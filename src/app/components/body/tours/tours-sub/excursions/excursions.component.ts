...
export class ExcursionsComponent implements OnInit {
  ...
  excursionCategoriesForFiltering: any
  ...
  ngOnInit() {
    ...
    this.excursionCategoriesForFiltering =  this.excursionCategories
  ...
  search() {
    if (!this.searchText) {
      return this.excursionCategoriesForFiltering;
    }
    if (this.searchText) {
      return this.filterIt(this.excursionCategoriesForFiltering.filter(item => delete item.mainDescription), this.searchText.toLowerCase());
    }
  }

  excursionsDetails(item_id) {
    this.selectedItem = this.excursionCategories[item_id]
  }
